...
function openGmail() {
  const email = "ardhaviu@gmail.com";
...
function downloadCV() {
  ...
  link.href = "UDIT ARDHAVI RESUME.pdf"; // Path to your resume file
  link.download = " UDIT ARDHAVI RESUME"; // Name for the downloaded file
